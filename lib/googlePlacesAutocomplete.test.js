...
test("resolveLanguageCode defaults missing values to English", () => {
...
test("getPlaceDetailsCacheKey includes placeId and language", () => {
    assert.equal(
        ...
        "geo:places:details:v2:ChIJ123:en"
    );
    assert.equal(getPlaceDetailsCacheKey("ChIJ123"), getPlaceDetailsCacheKey("ChIJ123", "en"));
});
